...
function DependantsAdding(props) {
  ...
  const onSavePersonalDetails = async imageUrl => {
    ...
    const NumOfDep =
      typeof dependantsDetails == 'undefined' ? 0 : dependantsDetails.length;
    let dependant = {};
 ...
 useEffect(() => {
  ...
  const uploadImage = async () => {
    if (image !== null) {
      const childPath = `dependantsProfiles/${
      ...
      <Block>
        <Block style={styles.container}>
          <Block
            ...
            <Button
              style={{width: 90, height: 44, marginHorizontal: 5, elevation: 0}}
              ...
              <Block row middle space="between" style={{marginTop: 50}}>
                <TouchableOpacity
                  ...
                  {image === null ? (
                    <Image
                      source={{
                        uri: 'https://firebasestorage.googleapis.com/v0/b/donewithit-db.appspot.com/o/Dummies%2FDummyProfileImage.png?alt=media&token=ef68ecf0-e374-490d-be52-45b79e0d87a1',
                      }}
                      style={styles.avatar}
                    />
                  ) : (
